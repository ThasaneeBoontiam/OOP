...
public class Lab7_2 implements ActionListener{
    ...
    public Lab7_2() {
        ...
        container.add( salaryLabel ); //add salaryLabel ลงในหน้าต่าง window
        ...
        taxField.setEditable( false );//ไม่สามารถให้ผู้ใช้กรอกได้
        ...
        btnCalculate = new JButton(" Calculate "); //สร้างปุ่ม Calculate
        btnCalculate.addActionListener( this); 
        container.add( btnCalculate );

        btnExit = new JButton(" Exit ");//สร้างปุ่ม Exit
